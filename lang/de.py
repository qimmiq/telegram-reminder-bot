...
s_common_welcome_text = (
    'Hallo! Wenn du eine neue Erinnerung einstellen möchtest, benutze das Kommando /newalarm'
    'Bitte beachte, fürs Erste sind nur 5 gleichzeitige Erinnerungen möglich')

s_common_guide_timezone = (
    'Gib deine Zeitzone ein. Im Format +x oder -x (only integers supported)\n'
    'Warnung! Zeitzone sollte passend zu GMT+0\n eingestellt werden')

s_common_guide_time = ('Wann soll ich dich erinnern?. zum Beispiel:\n\n'
